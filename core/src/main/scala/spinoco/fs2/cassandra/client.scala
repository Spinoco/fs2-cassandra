...
object client {
  ...
  /**
    ...
    */
  def cluster[F[_] : Async: Timer](config: Cluster.Builder, queryLogger: Option[QueryLogger] = None):Stream[F,CassandraCluster[F]] =
  ...
  /**
    ...
    */
  def session[F[_] : Async: Timer](config: Cluster.Builder, queryLogger: Option[QueryLogger] = None):Stream[F,CassandraSession[F]] =
